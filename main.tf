...
resource "aws_flow_log" "example" {
  log_destination      = "arn:aws:s3:::clc15-bruno-msilva-terraform"
...
#CRIA TABELA DE ROTA PUBLICA APONTANDO PARA O IGW
...
#CRIA TABELA DE ROTA PRIVADA PARA SUBNET 1A E 1B
...
resource "aws_route_table" "tf_private_rt_1a" {
  ...
  #ASSOCIA AS TABELAS DE ROTA PRIVADAS NAS SUBNETS PRIVADA
